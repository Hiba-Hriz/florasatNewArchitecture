...
BundlePkt * CustodyModel::custodyTimerExpired(CustodyTimeout * custodyTimeout){

	// Get bundle from custody Sdr if any
    BundlePkt * reSendBundle = sdr_->getTransmittedBundleInCustody(custodyTimeout->getBundleId());
